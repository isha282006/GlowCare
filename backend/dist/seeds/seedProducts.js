...
async function seedProducts() {
    try {
        ...
        // Insert all products
        const result = await RecommendedProduct_1.default.insertMany(exports.recommendedProducts);
        console.log(`Successfully seeded ${result.length} recommended products`);
        // Summary
        const categories = [...new Set(exports.recommendedProducts.map(p => p.category))];
        const brands = [...new Set(exports.recommendedProducts.map(p => p.brand))];
