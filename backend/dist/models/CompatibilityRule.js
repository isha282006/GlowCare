...
const CompatibilityRuleSchema = new mongoose_1.Schema({
    ingredientA: {
        type: String,
...
exports.default = mongoose_1.default.model('CompatibilityRule', CompatibilityRuleSchema);
//# sourceMappingURL=CompatibilityRule.js.map