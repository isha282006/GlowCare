...
const getProducts = async (req, res) => {
    try {
        ...
        const existingCount = await Product_1.default.countDocuments({ user: userId });
        ...
        if (existingCount === 0 && userDoc && !userDoc.hasInteractedWithInventory) {
            ...
            await Product_1.default.insertMany(seeded);
        }
...
const createProduct = async (req, res) => {
    try {
        ...
        await User_1.default.findByIdAndUpdate(req.user._id, { hasInteractedWithInventory: true });
